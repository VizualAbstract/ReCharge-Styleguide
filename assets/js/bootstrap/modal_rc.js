...
+function ($) {
  ...
  var ModalRC = function (element, options) {
    ...
    this.$dialog             = this.$element.find('.rc_modal__dialog')
    this.$backdrop           = null
    this.isShown             = null
  ...
  ModalRC.prototype.show = function (_relatedTarget) {
    ...
    this.checkScrollbar()
    this.setScrollbar()
    this.$body.addClass('rc_modal__open')

    this.escape()
    this.resize()

    this.$element.on('click.dismiss.bs.rc_modal', '[data-dismiss="rc_modal__window"]', $.proxy(this.hide, this))
  ...
  ModalRC.prototype.hide = function (e) {
    ...
    $.support.transition && this.$element.hasClass('rc_fade') ?
      this.$element
  ...
  ModalRC.prototype.hideModalRC = function () {
    ...
    this.$element.hide()
    this.backdrop(function () {
      that.$body.removeClass('rc_modal__open')
  ...
  ModalRC.prototype.backdrop = function (callback) {
    var that = this
    var animate = this.$element.hasClass('rc_fade') ? 'rc_fade' : ''

    if (this.isShown && this.options.backdrop) {
      var doAnimate = $.support.transition && animate

      this.$backdrop = $(document.createElement('div'))
        .addClass('rc_modal__backdrop ' + animate)
        .appendTo(this.$body)
      ...
      this.$backdrop.removeClass('rc_in')
  ...
  ModalRC.prototype.measureScrollbar = function () { // thx walsh
    ...
    scrollDiv.className = 'rc_modal__scrollbar-measure'
  ...
  $(document).on('click.bs.rc_modal.data-api', '[data-toggle="rc_modal__window"]', function (e) {
    var $this   = $(this)
